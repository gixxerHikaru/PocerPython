...
def quiz():
        ...
        screen.blit(font.render(str(remaining_time*0.001), True, black), [350, 200])
        pygame.display.update()
        pygame.time.wait(1000)
        screen.blit(font30.render("Your Score is", True, black), [150, 250])
        score = score * remaining_time*0.001
        screen.blit(font.render(str(score), True, black), [350, 240])
        pygame.display.update()
